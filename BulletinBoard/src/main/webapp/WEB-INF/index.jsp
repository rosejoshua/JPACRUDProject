...
<hr>
<div class="container-fluid pad8topbottom">
<table class="center">
<tr>
<th>#</th>
<th>Author</th>
...
<tr>
  ...
  <td><font face="Courier" >${b.dateTime}</font></td>
  <td>
...
<div class="container-fluid pad8topbottom footer">
<table class="center">
<tr>
...
<tr>
  ...
  <td>
  <input type="text" id="author" name="author" size="20" required/>
  </td>
  <td>
  <input type="text" id="post" name="post" size="50" required />
  </td>
  <td>
